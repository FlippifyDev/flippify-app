		...
		<div className="relative w-full max-w-lg mx-auto">
						...
						return (
							<li key={reward.id} className="flex items-center mb-4">
								...
								<div className="flex-1 px-2">
									<button
										className={`w-full p-4 rounded-lg transition-all duration-200 focus:border-houseBlue border bg-white ${isSelectedLeft
								...
								<div className="flex-1 px-2">
									<button
										className={`w-full p-4 rounded-lg transition-all duration-200 focus:border-houseBlue border bg-white ${isSelectedRight
												? "shadow-lg border-houseBlue"
												: "shadow-md border-transparent hover:shadow-lg"
											} ${isDisabled
												? "text-gray-400 border-gray-300 cursor-not-allowed"
			...
			{totalPages > 1 && (
				<div className="flex justify-center mt-4">
					<button
						className={`px-4 py-2 transition-all duration-200 border border-gray-300 rounded-l-lg bg-white text-gray-700 hover:bg-gray-100 ${currentPage === 0 ? "text-gray-400 cursor-not-allowed" : "hover:border-gray-400"
							}`}
					...
					<button
						className={`px-4 py-2 transition-all duration-200 border border-gray-300 rounded-r-lg bg-white text-gray-700 hover:bg-gray-100 ${currentPage === totalPages - 1 ? "text-gray-400 cursor-not-allowed" : "hover:border-gray-400"
							}`}
						onClick={() => setCurrentPage(currentPage + 1)}
