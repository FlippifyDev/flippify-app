...
const DashboardNoSubscription: React.FC<DashboardNoSubscriptionProps> = ({ username }) => {
  ...
  return (
    <div className="flex justify-center items-center h-full"> {/* Set to full height */}
      <div className="w-full h-auto flex flex-col justify-center"> {/* Center the content vertically */}
        <div className="text-center p-6">
          ...
          <div className="mb-6">
            ...
            <ul className="text-left space-y-2 mx-auto w-max"> {/* Adjust space between items */}
              {[
