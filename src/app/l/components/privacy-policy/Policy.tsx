...
const Policy = () => {
    ...
    return (
        <div className="text-gray-800">
            ...
            <br />
            <h1 className="">SUMMARY OF KEY POINTS</h1>
            <p>
                ...
                information. Do we collect any information from third parties? We may
                ...
                share your personal information. How do we keep your information safe?
                ...
                exercise your rights is by visiting https://discord.gg/gNPYfe7YFm, or by
                contacting us. We will consider and act upon any request in accordance
                with applicable data protection laws. Want to learn more about what we
                do with any information we collect? Review the privacy notice in full.
            </p>
            <br />
            <h1 className="">TABLE OF CONTENTS</h1>
            <p>
                ...
                12. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?<br />
                13. DO WE MAKE UPDATES TO THIS NOTICE?<br />
                14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?<br />
                15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
            </p>
            <br />
            <h1 className="">1. WHAT INFORMATION DO WE COLLECT?</h1>
            ...
            <p>
                ...
                addresses usernames passwords discord id stripe customer id Sensitive
                Information. We do not process sensitive information. Payment Data. We
                may collect data necessary to process your payment if you choose to make
                ...
                https://stripe.com/gb/privacy. Social Media Login Data. We may provide
            ...
            <p>
                ...
                partners, social media platforms, and other outside sources. In order to
                enhance our ability to provide relevant marketing, offers, and services
                to you and update our records, we may obtain information about you from
                ...
                titles, email addresses, phone numbers, intent data (or user behaviour
                ...
                and event promotion. If you interact with us on a social media platform
            ...
            <br />
            <h1 className="">2. HOW DO WE PROCESS YOUR INFORMATION?</h1>
            <p>
            ...
            <br />
            <h1 className="">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h1>
            <p>
                ...
                GDPR require us to explain the valid legal bases we rely on in order to
                process your personal information. As such, we may rely on the following
                legal bases to process your personal information: Consent. We may
                ...
                consent. Performance of a Contract. We may process your personal
                ...
                prior to entering into a contract with you. Legal Obligations. We may
                ...
                threats to the safety of any person. If you are located in Canada, this
                section applies to you. We may process your information if you have
                ...
                consent at any time. In some exceptional cases, we may be legally
                ...
                interests of an individual and consent cannot be obtained in a timely
                way For investigations and fraud detection and prevention For business
                transactions provided certain conditions are met If it is contained in a
                witness statement and the collection is necessary to assess, process, or
                settle an insurance claim For identifying injured, ill, or deceased
                persons and communicating with next of kin If we have reasonable grounds
                to believe an individual has been, is, or may be victim of financial
                abuse If it is reasonable to expect collection and use with consent
                would compromise the availability or the accuracy of the information and
                ...
                court order, or rules of the court relating to the production of records
            ...
            <br />
            <h1 className="">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h1>
            <p>
            ...
            <br />
            <h1 className="">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h1>
            <p>
            ...
            <br />
            <h1 className="">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h1>
            <p>
            ...
            <br />
            <h1 className="">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h1>
            <p>
            ...
            <br />
            <h1 className="">8. DO WE COLLECT INFORMATION FROM MINORS?</h1>
            <p>
            ...
            <br />
            <h1 className="">9. WHAT ARE YOUR PRIVACY RIGHTS?</h1>
            <p>
                ...
                are relying on your consent to process your personal information, which
                ...
                or for other non-marketing purposes. Account Information If you would at
                ...
                information provided. Upon your request to terminate your account, we
            ...
            <br />
            <h1 className="">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h1>
            <p>
                ...
                practice in a revised version of this privacy notice. California law
                requires us to let you know how we respond to web browser DNT signals.
            ...
            <br />
            <h1 className="">11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h1>
            <p>
                In Short: If you are a resident of California, Colorado, Connecticut,
                Delaware, Florida, Indiana, Iowa, Kentucky, Montana, New Hampshire, New
                ...
                Categories of Personal Information We Collect We have collected the
                following categories of personal information in the past twelve (12)
                months: Category Examples Collected A. Identifiers Contact details, such
                as real name, alias, postal address, telephone or mobile contact number,
                unique personal identifier, online identifier, Internet Protocol
                address, email address, and account name YES B. Personal information as
                defined in the California Customer Records statute Name, contact
                information, education, employment, employment history, and financial
                information NO C. Protected classification characteristics under state
                or federal law Gender, age, date of birth, race and ethnicity, national
                origin, marital status, and other demographic data NO D. Commercial
                information Transaction information, purchase history, financial
                details, and payment information NO E. Biometric information
                Fingerprints and voiceprints NO F. Internet or other similar network
                activity Browsing history, search history, online behaviour, interest
                data, and interactions with our and other websites, applications,
                systems, and advertisements NO G. Geolocation data Device location NO H.
                Audio, electronic, sensory, or similar information Images and audio,
                video or call recordings created in connection with our business
                activities NO I. Professional or employment-related information Business
                contact details in order to provide you our Services at a business level
                or job title, work history, and professional qualifications if you apply
                ...
                through our customer support channels; Participation in customer surveys
                or contests; and Facilitation in the delivery of our Services and to
                respond to your inquiries. We will use and retain the collected personal
                information as needed to provide the Services or for: Category A - Until
                ...
                other consumers. Your Rights You have rights under certain US state data
                protection laws. However, these rights are not absolute, and in certain
                cases, we may decline your request as permitted by law. These rights
                include: Right to know whether or not we are processing your personal
                data Right to access your personal data Right to correct inaccuracies in
                ...
                behalf in accordance with applicable laws. Request Verification Upon
                ...
                fraud-prevention purposes. If you submit the request through an
                authorised agent, we may need to collect additional information to
                verify your identity before processing your request and the agent will
            ...
            <br />
            <h1 className="">12. DO OTHER REGIONS HAVE SPECIFIC PRIVACY RIGHTS?</h1>
            <p>
                ...
                necessary to fulfil their applicable purpose, it may affect our ability
                to provide our services, in particular: offer you the products or
                services that you want respond to or help with your requests manage your
            ...
            <br />
            <h1 className="">13. DO WE MAKE UPDATES TO THIS NOTICE?</h1>
            <p>
            ...
            <br />
            <h1 className="">14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h1>
            <p>
                If you have questions or comments about this notice, you may email us at
                support@{domain}
            </p>
            <br />
            <h1 className="">15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h1>
            <p>
                ...
                information, please visit: https://discord.gg/gNPYfe7YFm.
            </p>
        </div>
    );
}
