...
const PrivacyPolicy = () => {
	return (
		<div className="text-white">
			...
			<br />
			<h1 className="text-white">1. WHAT INFORMATION DO WE COLLECT?</h1>
			...
			<br />
			<h1 className="text-white">2. HOW DO WE PROCESS YOUR INFORMATION?</h1>
			<p>
			...
			<br />
			<h1 className="text-white">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h1>
			<p>
			...
			<br />
			<h1 className="text-white">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h1>
			<p>
			...
			<br />
			<h1 className="text-white">5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h1>
			<p>
			...
			<br />
			<h1 className="text-white">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h1>
			<p>
			...
			<br />
			<h1 className="text-white">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h1>
			<p>
			...
			<br />
			<h1 className="text-white">8. DO WE COLLECT INFORMATION FROM MINORS?</h1>
			<p>
			...
			<br />
			<h1 className="text-white">11. DO UNITED STATES RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</h1>
			<p>
			...
			<br />
			<h1 className="text-white">13. DO WE MAKE UPDATES TO THIS NOTICE?</h1>
			<p>
