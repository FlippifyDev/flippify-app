  ...
  return (
    <div className="relative group cursor-pointer">
      <div className="grid grid-cols-12 px-2">
        ...
        <span className="2xl:col-span-11 col-span-10 flex items-center font-semibold text-gray-400 group-hover:text-houseBlue transition-colors duration-200 select-none text-md 2xl:text-base">{text}</span>
      </div>
      <div 
