			...
			<ul className={rootClass}>
				<li className="w-full">
					<PlansClickableBulletPoint
                        ...
                        tooltip="Track up to 500 new eBay listings monthly. Log the purchase, and we&apos;ll automatically monitor inventory, sales, and financials. Limit resets each month; active tracked items don&apos;t count toward the next month&apos;s cap. On initial sign-up we can only track 90 days in the past and up to 1000 items."
					/>
				</li>
			</ul>
