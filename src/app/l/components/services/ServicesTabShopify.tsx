		...
		<div className="flex flex-col justify-center xl:w-11/12 h-full mb-5 mt-5">
			<div className="flex flex-col items-center space-y-3 text-center mb-5">
				...
				<div className="flex justify-center max-w-2xl">
					...
					Automate your Shopify store with AI-driven tools for product listing, order fulfillment, inventory management, and financial tracking, helping you scale effortlessly.
					</p>
				</div>
			</div>
