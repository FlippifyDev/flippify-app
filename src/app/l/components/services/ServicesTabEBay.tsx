		...
		<div className="flex flex-col justify-center xl:w-11/12 h-full mb-5 mt-5">
			...
			<div className="flex flex-wrap justify-center ">
				<ServicesToolsCard
					...
					disclaimer={null}
					image="https://i.imgur.com/y71yZKr.png"
				/>
				<ServicesToolsCard
					...
					disclaimer={null}
					image="https://i.imgur.com/0Cx2HjI.png"
				/>
				<ServicesToolsCard
				...
				<ServicesToolsCard
					...
					disclaimer={null}
					image="https://i.imgur.com/DS1U7iS.png"
				/>
				<ServicesToolsCard
					...
					disclaimer={null}
					image="https://i.imgur.com/NdskFBj.png"
				/>
				<ServicesToolsCard
				...
				<ServicesToolsCard
					...
					disclaimer={null}
					image="https://i.imgur.com/Yn2L32K.png"
				/>
				<ServicesToolsCard
