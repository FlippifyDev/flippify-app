...
const Terms = () => {
    ...
    return (
        <div className="text-gray-800">
            ...
            <br />
            <h1 className="">AGREEMENT TO OUR LEGAL TERMS</h1>
            <p>
            ...
            <br />
            <h1 className="">1. OUR SERVICES</h1>
            <p>
            ...
            <br />
            <h1 className="">2. INTELLECTUAL PROPERTY RIGHTS</h1>
            <p>
            ...
            <br />
            <h1 className="">3. USER REPRESENTATIONS</h1>
            <p>
            ...
            <br />
            <h1 className="">4. USER REGISTRATION</h1>
            <p>
            ...
            <br />
            <h1 className="">5. PURCHASES AND PAYMENT</h1>
            <p>
            ...
            <br />
            <h1 className="">6. SUBSCRIPTIONS</h1>
            <p>
            ...
            <br />
            <h1 className="">7. PROHIBITED ACTIVITIES</h1>
            <p>
            ...
            <br />
            <h1 className="">8. USER GENERATED CONTRIBUTIONS</h1>
            <p>
            ...
            <br />
            <h1 className="">9. CONTRIBUTION LICENCE</h1>
            <p>
            ...
            <br />
            <h1 className="">10. SOCIAL MEDIA</h1>
            <p>
            ...
            <br />
            <h1 className="">11. THIRD-PARTY WEBSITES AND CONTENT</h1>
            <p>
            ...
            <br />
            <h1 className="">12. SERVICES MANAGEMENT</h1>
            <p>
            ...
            <br />
            <h1 className="">13. PRIVACY POLICY</h1>
            <p>
            ...
            <br />
            <h1 className="">14. TERM AND TERMINATION</h1>
            <p>
            ...
            <br />
            <h1 className="">15. MODIFICATIONS AND INTERRUPTIONS</h1>
            <p>
            ...
            <br />
            <h1 className="">16. GOVERNING LAW</h1>
            <p>
            ...
            <br />
            <h1 className="">17. DISPUTE RESOLUTION</h1>
            <p>
            ...
            <br />
            <h1 className="">18. CORRECTIONS</h1>
            <p>
            ...
            <br />
            <h1 className="">20. LIMITATIONS OF LIABILITY</h1>
            <p>
            ...
            <br />
            <h1 className="">21. INDEMNIFICATION</h1>
            <p>
            ...
            <br />
            <h1 className="">24. CALIFORNIA USERS AND RESIDENTS</h1>
            <p>
            ...
            <br />
            <h1 className="">25. MISCELLANEOUS</h1>
            <p>
