...
const StoreManagementDashboardShowcase = () => {
    return (
        <div className="w-full max-w-7xl mx-auto px-6 sm:px-6 md:px-8 lg:px-10 xl:px-12 md:order-2 border-2 border-white bg-gray-100/80 p-2 rounded-4xl shadow-lg ml-0">
            <figure>
                <Image
