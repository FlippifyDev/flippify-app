...
import { getDatabase, ref, get, set, push, child, query, orderByChild, equalTo, increment, onValue, remove } from 'firebase/database';
...
export { database, auth, ref, get, set, push, child, query, orderByChild, equalTo, increment, onValue, remove };
