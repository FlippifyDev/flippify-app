...
const PlansCard: React.FC<PlansCardProps> = ({
  ...
  const rateToGBP = conversionRates['GBP'];
  const originalPricesConverted = {
    monthly: prices.monthly * (conversionRates[currency] / rateToGBP),
    yearly: prices.yearly * (conversionRates[currency] / rateToGBP),
  };

  const discountedPricesConverted = {
    monthly: discountedPrices.monthly * (conversionRates[currency] / rateToGBP),
    yearly: discountedPrices.yearly * (conversionRates[currency] / rateToGBP),
  };
  ...
  const displayPriceEnterprise =
    ...
    (conversionRates[currency] / rateToGBP);
