  ...
  return (
    <div>
      ...
      <p>
        ...
        AND YOU MUST DISCONTINUE USE IMMEDIATELY. An update will be clearly
        announced within the discord servers updates channel. The Services are
        ...
        to you using the Services. We recommend that you print a copy of these
      ...
      <p>
        ...
        4. USER REGISTRATION 5. PURCHASES AND PAYMENT 6. SUBSCRIPTIONS 7.
        PROHIBITED ACTIVITIES 8. USER GENERATED CONTRIBUTIONS 9. CONTRIBUTION
        LICENCE 10. SOCIAL MEDIA 11. THIRD-PARTY WEBSITES AND CONTENT 12.
        SERVICES MANAGEMENT 13. PRIVACY POLICY 14. TERM AND TERMINATION 15.
        ...
        INDEMNIFICATION 22. USER DATA 23. ELECTRONIC COMMUNICATIONS,
        TRANSACTIONS, AND SIGNATURES 24. CALIFORNIA USERS AND RESIDENTS 25.
        MISCELLANEOUS 26. CONTACT US
      </p>
      <br />
      <h1 className="text-white">1. OUR SERVICES</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">2. INTELLECTUAL PROPERTY RIGHTS</h1>
      <p>
        ...
        personal, non-commercial use or internal business purpose. Except as set
        out in this section or elsewhere in our Legal Terms, no part of the
        ...
        such Submission; warrant that any such Submission are original to you or
      ...
      <br />
      <h1 className="text-white">3. USER REPRESENTATIONS</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">4. USER REGISTRATION</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">5. PURCHASES AND PAYMENT</h1>
      <p>
        We accept the following forms of payment: - Stripe You agree to provide
        ...
        time. All payments shall be in Any. You agree to pay all charges at the
      ...
      <br />
      <h1 className="text-white">6. SUBSCRIPTIONS</h1>
      <p>
        Billing and Renewal Your subscription will continue and automatically
        renew unless cancelled. You consent to our charging your payment method
        ...
        plan you choose when you subscribed to the Services. Cancellation You
      ...
      <br />
      <h1 className="text-white">7. PROHIBITED ACTIVITIES</h1>
      <p>
        ...
        transfer your profile. Use the Services to advertise or offer to sell
        goods and services anywhere other than designated sections in the
        discord server.
      </p>
      <br />
      <h1 className="text-white">8. USER GENERATED CONTRIBUTIONS</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">9. CONTRIBUTION LICENCE</h1>
      <p>
        ...
        suggestions or other feedback regarding the Services, you agree that we
      ...
      <br />
      <h1 className="text-white">10. SOCIAL MEDIA</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">12. SERVICES MANAGEMENT</h1>
      <p>
      ...
      <p>
        ...
        transferring your data to the United Kingdom, and you expressly consent
      ...
      <br />
      <h1 className="text-white">14. TERM AND TERMINATION</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">15. MODIFICATIONS AND INTERRUPTIONS</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">16. GOVERNING LAW</h1>
      <p>
        ...
        provisions of the law in your country to residence. Flippify and
        yourself both agree to submit to the non-exclusive jurisdiction of the
        courts of North Yorkshire, which means that you may make a claim to
      ...
      <br />
      <h1 className="text-white">17. DISPUTE RESOLUTION</h1>
      <p>
        ...
        clause constitutes acceptance. The seat of arbitration shall be Leeds,
      ...
      <br />
      <h1 className="text-white">18. CORRECTIONS</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">19. DISCLAIMER</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">20. LIMITATIONS OF LIABILITY</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">21. INDEMNIFICATION</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">22. USER DATA</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">24. CALIFORNIA USERS AND RESIDENTS</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">25. MISCELLANEOUS</h1>
      <p>
      ...
      <br />
      <h1 className="text-white">26. CONTACT US</h1>
      <p>
