    ...
    return (
        ...
        >
            <svg
                ...
                height="22px"
                viewBox="0 0 24 24"
                className="stroke-zinc-800 fill-none group-hover:fill-zinc-200 group-active:stroke-zinc-200 group-active:fill-zinc-300 group-active:duration-0 duration-300"
            >
                <path
