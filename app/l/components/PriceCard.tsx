...
const PriceCard: React.FC<PriceCardProps> = ({ title, prices, priceIds, description, image }) => {
  ...
  return (
    <div className="m-5 sm:scale-90 md:scale-90 lg:max-w-5xl xl:max-w-6xl w-auto">
      <div className="card lg:card-side bg-base-100 shadow-xl opacity-90 border border-white sm:flex sm:justify-center sm:flex-col mt-20">
        ...
        <div className="w-full lg:w-3/4 xl:w-3/4 p-4 lg:p-6">
          ...
          <p className="text-white text-sm lg:text-base mb-4 flex justify-center">{description}</p>
