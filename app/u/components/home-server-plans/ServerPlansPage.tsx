...
const ServerPlansPage = () => {
  return (
    <div className="flex flex-col justify-center w-full min-h-screen rounded-lg bg-white shadow-planCardShadow border mb-2">
      <div className="flex flex-col items-center space-y-5 text-center mt-8">
      ...
      <div className="mt-4 flex flex-wrap justify-center mb-8">
        <ServerPlansCard
