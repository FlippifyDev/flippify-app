...
const PriceCard: React.FC<PriceCardProps> = ({
  ...
  return (
    <div className="flex justify-center sm:scale-90 md:scale-90 lg:max-w-2xl xl:max-w-3xl w-auto px-0 mx-2 sm:mx-0 sm:px-32">
      <div className="card lg:card-side bg-base-100 shadow-xl opacity-97 border border-white flex flex-col items-center justify-center mt-20 pt-6 pb-6">
        <div className="w-full px-8 sm:px-6">
          ...
          <div className="flex flex-col items-start text-white pt-6 pb-6 pl-2 sm:text-lg">
            ...
            <div className="grid grid-cols-12 mb-2 items-center">
              <IoMdCheckboxOutline className="col-span-1 inline-block mr-3 text-paymentPlanText" />
              <p className="ml-1 sm:ml-0 col-span-11 mb-0 text-left">Priority Support.</p>
            </div>
            <div className="grid grid-cols-12 mb-2 items-center">
              <IoMdCheckboxOutline className="col-span-1 inline-block mr-3 text-paymentPlanText" />
              <p className="ml-1 sm:ml-0 col-span-11 mb-0 text-left">
          ...
          <div className="flex justify-end mt-2">
            {prices.length > 0 && selectedPlan !== null && <SubscribeNow />}
          </div>
        </div>
      </div>
    </div>
