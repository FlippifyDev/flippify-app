...
// Local Imports
import { createStockXToken } from '@/services/oauth/stockx/create-token';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        const tokenData = await createStockXToken(code);
        ...
        const tokenAdditionResponse = await addToken({ store: "stockx", tokenData, session });
